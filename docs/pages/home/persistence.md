...
By default, Figgy formats the output JSON for readability (AKA [prettifies JSON](https://manual.gamemaker.io/lts/en/GameMaker_Language/GML_Reference/File_Handling/Encoding_And_Hashing/json_stringify.htm#:~:text=Example%202%3A%20Pretty%20Print)). If you prefer compact JSON instead, you can disable this by setting the :FIGGY_FILE_PRETTIFY: macro to `false`.

## Obfuscation

Figgy supports basic file obfuscation using [base64_encode()](https://manual.gamemaker.io/lts/en/GameMaker_Language/GML_Reference/File_Handling/Encoding_And_Hashing/base64_encode.htm) and [buffer_compress()](https://manual.gamemaker.io/lts/en/GameMaker_Language/GML_Reference/Buffers/buffer_compress.htm), helping prevent players from casually viewing or editing your config file.

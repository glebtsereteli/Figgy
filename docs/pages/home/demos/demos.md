...
<div style="display:flex;gap:12px;justify-content:space-between;flex-wrap:wrap;width:100%">
  <figure style="text-align:center;flex:1;min-width:150px">
    ...
    <figcaption><a href="https://github.com/glebtsereteli/Figgy/releases/latest/download/Figgy.v1.1.0.Demo.GMTemplate.Platformer.yyz" target="_blank" rel="noopener noreferrer">Platformer</a></figcaption>
  </figure>
  <figure style="text-align:center;flex:1;min-width:150px">
    <img src="/pages/home/demos/demoSurvivor.png" style="width:100%;max-width:220px" data-zoomable>
    <figcaption><a href="https://github.com/glebtsereteli/Figgy/releases/latest/download/Figgy.v1.1.0.Demo.GMTemplate.Survivor.yyz" target="_blank" rel="noopener noreferrer">Survivor</a></figcaption>
  </figure>
  <figure style="text-align:center;flex:1;min-width:150px">
    <img src="/pages/home/demos/demoHero.png" style="width:100%;max-width:220px" data-zoomable>
    <figcaption><a href="https://github.com/glebtsereteli/Figgy/releases/latest/download/Figgy.v1.1.0.Demo.GMTemplate.Hero.s.Trail.yyz" target="_blank" rel="noopener noreferrer">Hero's Trail</a></figcaption>
  </figure>
</div>
...
* Mouse input (both for UI interactions and in-game movement) is blocked when hovering over the overlay using [is_mouse_over_debug_overlay()](https://manual.gamemaker.io/lts/en/GameMaker_Language/GML_Reference/Debugging/is_mouse_over_debug_overlay.htm), preventing unwanted input while editing configs.

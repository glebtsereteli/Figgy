...
<div style="display:flex;gap:12px;justify-content:space-between;flex-wrap:wrap;width:100%">
  <figure style="text-align:center;flex:1;min-width:150px">
    ...
    <figcaption><a href="https://github.com/glebtsereteli/Figgy/releases/latest" target="_blank" rel="noopener noreferrer">Hero's Trail</a></figcaption>
  </figure>
  <figure style="text-align:center;flex:1;min-width:150px">
    <img src="/pages/home/demos/demoPlatformer.png" style="width:100%;max-width:220px" data-zoomable>
    <figcaption><a href="https://github.com/glebtsereteli/Figgy/releases/latest" target="_blank" rel="noopener noreferrer">Platformer</a></figcaption>
  </figure>
  <figure style="text-align:center;flex:1;min-width:150px">
    <img src="/pages/home/demos/demoSurvivor.png" style="width:100%;max-width:220px" data-zoomable>
    <figcaption><a href="https://github.com/glebtsereteli/Figgy/releases/latest" target="_blank" rel="noopener noreferrer">Survivor</a></figcaption>
  </figure>
</div>

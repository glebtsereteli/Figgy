...
cfg = CFG.Character; // @Figgy: Store config struct in a variable to reference throughout the object.

// This is the horizontal movement speed of the character.
// It's in pixels per second.
//move_speed = 8; @Figgy: Using config.
...
//grav_speed = 1; @Figgy: Using config.

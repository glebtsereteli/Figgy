# Figgy Demo - GameMaker Hero's Trail Template

Welcome to the GMTemplate Hero's Trail Figgy demo!

This project demonstrates how easily Figgy can be integrated into an existing GameMaker project.

In this demo, we're using GameMaker's official [Hero's Trail template](https://marketplace.gamemaker.io/assets/10490/hero-s-trail-complete-gml) as a base project. All mechanics are preserved exactly as they are in the original template.

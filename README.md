...
<h1 align="center">Figgy v1.1.0 </h1>
<p align="center">
  Persistent live configs for <a href="https://releases.gamemaker.io/release-notes/2026/0"> GameMaker LTS 2026</a>
</p>

<br/>

Figgy is a pure GML [Free and Open Source](https://en.wikipedia.org/wiki/Free_and-open-source_software) lightweight GameMaker library - a centralized and persistent live configuration system for seamless game tuning and balancing.

* ℹ️ Download the `.yymps` local package from the [latest releases](https://github.com/glebtsereteli/Figgy/releases/latest) page.
...
🎛️ **Wide Data Type Coverage**. Built on GameMaker's cross-platform Debug Overlay, Figgy provides many Value Widgets for all commonly used data types: [Integers](https://glebtsereteli.github.io/Figgy/pages/api/figgy/setup#int)​, [Floats](https://glebtsereteli.github.io/Figgy/pages/api/figgy/setup#float)​, [Reals](https://glebtsereteli.github.io/Figgy/pages/api/figgy/setup#real)​, [Booleans](https://glebtsereteli.github.io/Figgy/pages/api/figgy/setup#bool), [Strings](https://glebtsereteli.github.io/Figgy/pages/api/figgy/setup#string), [Colors](https://glebtsereteli.github.io/Figgy/pages/api/figgy/setup#color), [Anys](https://glebtsereteli.github.io/Figgy/pages/api/figgy/setup#any)​, [Curves](https://glebtsereteli.github.io/Figgy/pages/api/figgy/setup#curve), and [Assets](https://glebtsereteli.github.io/Figgy/pages/api/figgy/setup#asset).
...
👨‍🎨 **Code-Free Design**. Allow your designers to tweak and balance the game live through the [Interface](https://glebtsereteli.github.io/Figgy/pages/home/interface/interface), without ever having to touch code.

# Credits
* Created and maintained by [Gleb Tsereteli](https://linktr.ee/GlebTsereteli).
* Wonderful promo art by [neerikiffu](https://bsky.app/profile/neerikiffu.bsky.social).
...
* Thanks to [Omar Cornut](https://www.miracleworld.net/) for making the infinitely useful [Dear ImGui](https://github.com/ocornut/imgui) and the GameMaker team for implementing it in the [Debug Overlay](https://manual.gamemaker.io/lts/en/GameMaker_Language/GML_Reference/Debugging/The_Debug_Overlay.htm).
